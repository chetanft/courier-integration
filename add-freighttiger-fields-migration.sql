-- Migration to add FreightTiger API fields to couriers table
...
BEGIN
    ...
    -- Note: created_at and updated_at should already exist in the table
    -- If they don't, we'll add them
